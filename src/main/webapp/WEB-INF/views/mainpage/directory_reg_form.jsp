...
<html>
    ...
    <script type="text/javascript"
		  src="${pageContext.request.contextPath}/resources/js/httpRequest.js">
	</script>
        ...
        <script type="text/javascript">
            ...
            function uploadFile() {
                ...
                if (confirm("등록 하시겠습니까?")) {
                    ...
                    // 나중에 주어진 창에 입힐때 다시 하기.
                    // 지금은 ajax로 해서 다시 목록으로 가면 새로고침 안됨.
                    $.ajax({
                        url : "directory_insert.do",
                        data : formData,
                        type : 'POST',
                        ...
                        cache : false,
                        success : 
                        	location.replace("directory_list.do") 
//                     location.href="directory_list.do"
    ...
    <body>
        ...
        <input type="button" onclick="uploadFile();" class="btn bg_01" value="파일 업로드">
