...
<body>
    ...
    <form class="signup-form" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-body">
        ...
        <div class="horizontal-group">
          <div class="form-group left">
            ...
            <input type="text" name="m_nick" class="form-input" placeholder="enter your Nick name" required="required" />
          </div>
          <div class="form-group right">
            <label for="lastname" class="label-title">Full name</label>
            <input type="text" name="m_name" class="form-input" placeholder="enter your full name" />
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <input type="email" name="m_email" id="m_email" class="form-input" placeholder="enter your email" required="required">
        ...
        <div class="horizontal-group">
          <div class="form-group left">
            ...
            <input type="text" name="m_phone" class="form-input" placeholder="enter your Phone number" required="required">
          </div>
           <div class="form-group left" >
      ...
      <div class="form-footer">
        <span>* required</span>
        <button type="submit" id="create" class="btn" onclick="idcheck();">Create</button>
      </div>
      </div>
    </form>
